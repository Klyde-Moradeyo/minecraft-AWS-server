...
module "labels" {
  ...
  source = "github.com/Klyde-Moradeyo/minecraft-AWS-server//modules/labels?ref=dev-tf-infra-service-modules"
...
########################
module "vpc" {
  source = "github.com/Klyde-Moradeyo/minecraft-AWS-server//modules/vpc?ref=dev-tf-infra-service-modules"
}
...
########################
module "eip" {
  source = "github.com/Klyde-Moradeyo/minecraft-AWS-server//modules/eip?ref=dev-tf-infra-service-modules"
...
module "ssm_mc_server_private_key" {
  source = "github.com/Klyde-Moradeyo/minecraft-AWS-server//modules/ssm?ref=dev-tf-infra-service-modules"
...
########################
module "ecs_cluster" {
  source = "github.com/Klyde-Moradeyo/minecraft-AWS-server//modules/ecs?ref=dev-tf-infra-service-modules"
...
########################
module "api_gateway" {
  source = "github.com/Klyde-Moradeyo/minecraft-AWS-server//modules/api_gateway?ref=dev-tf-infra-service-modules"
...
########################
module "lambda" {
  source = "github.com/Klyde-Moradeyo/minecraft-AWS-server//modules/lambda?ref=dev-tf-infra-service-modules"
...
module "s3_mc_world" {
  source = "github.com/Klyde-Moradeyo/minecraft-AWS-server//modules/s3?ref=dev-tf-infra-service-modules"
