...
variable "instance_type" {
  ...
  type = string
  default = "m6i.xlarge" // "m6a.xlarge" -- Sim distance: 25 - it struggled potentially due to cpu usage	// For tests: "t2.medium" | https://amazon-aws-ec2-pricing-comparison.pcapps.com/
}
