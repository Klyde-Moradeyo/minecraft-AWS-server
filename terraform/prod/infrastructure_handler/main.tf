...
module "labels" {
  ...
  source = "git@github.com:Klyde-Moradeyo/minecraft-AWS-server.git//modules/labels?ref=TF_0.0.2"
...
########################
module "vpc" {
  source = "git@github.com:Klyde-Moradeyo/minecraft-AWS-server.git//modules/vpc?ref=TF_0.0.2"
}
...
########################
module "eip" {
  source = "git@github.com:Klyde-Moradeyo/minecraft-AWS-server.git//modules/eip?ref=TF_0.0.2"
...
module "ssm_mc_server_private_key" {
  source = "git@github.com:Klyde-Moradeyo/minecraft-AWS-server.git//modules/ssm?ref=TF_0.0.2"
...
########################
module "ecs_cluster" {
  source = "git@github.com:Klyde-Moradeyo/minecraft-AWS-server.git//modules/ecs?ref=TF_0.0.2"
...
########################
module "api_gateway" {
  source = "git@github.com:Klyde-Moradeyo/minecraft-AWS-server.git//modules/api_gateway?ref=TF_0.0.2"
...
########################
module "lambda" {
  source = "git@github.com:Klyde-Moradeyo/minecraft-AWS-server.git//modules/lambda?ref=TF_0.0.2"
...
module "s3_mc_world" {
  source = "git@github.com:Klyde-Moradeyo/minecraft-AWS-server.git//modules/s3?ref=TF_0.0.2"
